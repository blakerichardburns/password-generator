...
function generatePassword() {
  ...
  if (possibleCharacters.length === 0) {
    alert(
      'You have chosen NO to Uppercase Letters, Lowercase Letters, Numbers, and Special Characters. We have no available characters to generate your password...'
    );
    return;
  }
